    ...
    <div className="flex flex-col items-center justify-center min-h-[80vh] text-foreground p-6">
      ...
      >
        ...
        <div className="space-y-2">
          <h1 className="text-xl font-bold tracking-tight">Advanced Fleet Analytics</h1>
          <span className="text-[10px] text-indigo-400 font-bold uppercase tracking-widest font-mono block">
            Phase 8 • Scheduled Release
          </span>
          <p className="text-xs text-muted-foreground leading-relaxed max-w-xs mx-auto">
            Generate carbon offset estimates, runtime utilization reports, and operational financial summaries.
          </p>
        </div>
